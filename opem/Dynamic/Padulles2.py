...
def PH2O_Calc(KH2O, tH2O, Kr, I, qH2O):
    ...
    try:
        ...
        print(
            "[Error] PH2O Calculation Failed (KH2O:%s, tH2O:%s, Kr:%s, I:%s, qH2O:%s)" %
            (str(KH2O), str(tH2O), str(Kr), str(I), str(qH2O)))
...
def Dynamic_Analysis(
        ...
        ReportMode=True):
    """
    Run Padulles II analysis  with calling other functions.
        ...
        while i < IEnd:
            try:
                ...
                Output_Dict["PH2O"] = PH2O_Calc(
                    Input_Dict["KH2O"], Input_Dict["tH2O"], Kr, i, qH2O)
